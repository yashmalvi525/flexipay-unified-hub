  ...
  return (
    <AppLayout>
      <div className="space-y-6 animate-fade-in px-2 sm:px-0 max-w-lg mx-auto">
        ...
        <Card className="border-2 border-flexipay-purple/30 relative overflow-hidden no-zoom">
          ...
          <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex items-center justify-center p-2 bg-white/80 dark:bg-black/50 backdrop-blur-sm rounded-full shadow-lg border border-flexipay-purple/20">
